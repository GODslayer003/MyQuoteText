            ...
            >
              <div className="relative">
                ...
                <img
                  ...
                  className="h-90 lg:h-95 w-auto object-contain"
                />
            ...
            <div className="hidden lg:flex items-center space-x-2">
              {navigationItems.map((item) => (
                <Link
                  key={item.path}
                  to={item.path}
                  className={`relative px-4 py-2 text-sm font-medium transition-all duration-200 rounded-lg ${isActive(item.path)
            ...
            <div className="py-4 space-y-2">
              {navigationItems.map((item) => (
                <Link
                  key={item.path}
                  to={item.path}
                  className={`block px-4 py-3 text-base font-medium rounded-lg transition-all duration-200 ${isActive(item.path)
                      ? 'text-orange-600 bg-orange-50'
                      : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                    }`}
                  onClick={() => setMobileMenuOpen(false)}
              ...
              <Link
                to="/check-quote"
                className="block px-4 py-3 bg-gradient-to-r from-orange-500 to-amber-700 text-white rounded-lg font-semibold text-center hover:shadow-lg hover:shadow-orange-500/30 transition-all duration-300"
                onClick={() => setMobileMenuOpen(false)}
              >
                Check Your Quote
              </Link>
            ...
            <div className="lg:col-span-2">
              <Link to="/" className="inline-block mb-4">
                <img
                  src={logo}
                  alt="MyQuoteMate Logo"
                  className="h-70 lg:h-75 w-auto object-contain"
                />
              </Link>
